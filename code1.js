...
{runtimeScene.getScene().getVariables().get("State").setString("NotStarted");
    ...
    gdjs.GameCode.GDBlackRectObjects1[i].getBehavior("Tween").addObjectOpacityTween("FadeIn", 0, "linear", 250, true);
}
}}
...
};gdjs.GameCode.mapOfGDgdjs_46GameCode_46GDTopPillarObjects3Objects = Hashtable.newFrom({"TopPillar": gdjs.GameCode.GDTopPillarObjects3});
gdjs.GameCode.mapOfGDgdjs_46GameCode_46GDBottomPillarObjects3Objects = Hashtable.newFrom({"BottomPillar": gdjs.GameCode.GDBottomPillarObjects3});
...
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.GameCode.mapOfGDgdjs_46GameCode_46GDTopPillarObjects3Objects, 450, gdjs.randomInRange(30, 110), "");
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.GameCode.mapOfGDgdjs_46GameCode_46GDBottomPillarObjects3Objects, 450, (( gdjs.GameCode.GDTopPillarObjects3.length === 0 ) ? 0 :gdjs.GameCode.GDTopPillarObjects3[0].getPointY("")) + 350, "");
...
for(var i = 0, len = gdjs.GameCode.GDTopPillarObjects3.length ;i < len;++i) {
    ...
    gdjs.GameCode.GDBottomPillarObjects3[i].setAnimation(gdjs.random(1));
}
}{for(var i = 0, len = gdjs.GameCode.GDTopPillarObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDTopPillarObjects3[i].setAnimation(gdjs.random(1));
}
}}
...
};gdjs.GameCode.asyncCallback10199228 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.GameCode.asyncCallback10199228(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10197388);
}
}
}
if (isConditionTrue_0) {
...
};gdjs.GameCode.mapOfGDgdjs_46GameCode_46GDTappyPlaneObjects1Objects = Hashtable.newFrom({"TappyPlane": gdjs.GameCode.GDTappyPlaneObjects1});
gdjs.GameCode.mapOfGDgdjs_46GameCode_46GDTopPillarObjects1ObjectsGDgdjs_46GameCode_46GDBottomPillarObjects1ObjectsGDgdjs_46GameCode_46GDCeilingObjects1ObjectsGDgdjs_46GameCode_46GDGroundObjects1Objects = Hashtable.newFrom({"TopPillar": gdjs.GameCode.GDTopPillarObjects1, "BottomPillar": gdjs.GameCode.GDBottomPillarObjects1, "Ceiling": gdjs.GameCode.GDCeilingObjects1, "Ground": gdjs.GameCode.GDGroundObjects1});
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.GameCode.mapOfGDgdjs_46GameCode_46GDTappyPlaneObjects1Objects, gdjs.GameCode.mapOfGDgdjs_46GameCode_46GDTopPillarObjects1ObjectsGDgdjs_46GameCode_46GDBottomPillarObjects1ObjectsGDgdjs_46GameCode_46GDCeilingObjects1ObjectsGDgdjs_46GameCode_46GDGroundObjects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10189516);
}
if (isConditionTrue_0) {
{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "pipe_spawn");
}}
...
};gdjs.GameCode.mapOfGDgdjs_46GameCode_46GDFlashObjects2Objects = Hashtable.newFrom({"Flash": gdjs.GameCode.GDFlashObjects2});
...
{gdjs.evtTools.storage.readNumberFromJSONFile("save", "high_score", runtimeScene, runtimeScene.getScene().getVariables().get("PreviousBestScore"));
    ...
    gdjs.GameCode.GDHighScoreObjects4[i].setString("Best: " + gdjs.evtTools.common.toString(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("PreviousBestScore"))));
}
}}
...
{for(var i = 0, len = gdjs.GameCode.GDPlayerNameInputObjects4.length ;i < len;++i) {
    gdjs.GameCode.GDPlayerNameInputObjects4[i].setString(gdjs.playerAuthentication.getUsername());
}
}{for(var i = 0, len = gdjs.GameCode.GDPlayerNameInputObjects4.length ;i < len;++i) {
...
{for(var i = 0, len = gdjs.GameCode.GDPlayerNameInputObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDPlayerNameInputObjects3[i].setString(gdjs.evtTools.variable.getVariableString(runtimeScene.getGame().getVariables().get("PlayerName")));
}
}}
...
};gdjs.GameCode.asyncCallback10202356 = function (runtimeScene, asyncObjectsList) {
...
{for(var i = 0, len = gdjs.GameCode.GDFlashObjects3.length ;i < len;++i) {
    ...
    gdjs.GameCode.GDFinalScoreObjects3[i].setString("Score: " + gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().getFromIndex(0)));
}
}{for(var i = 0, len = gdjs.GameCode.GDFinalScoreObjects3.length ;i < len;++i) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.GameCode.asyncCallback10202356(runtimeScene, asyncObjectsList)));
}
}
...
isConditionTrue_0 = gdjs.playerAuthentication.isAuthenticated();
if (isConditionTrue_0) {
{gdjs.evtTools.leaderboards.saveConnectedPlayerScore(runtimeScene, "cb53c2e6-d603-4913-8728-ae0108ba3eee", gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(0)));
}}
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("PlayerNameInput"), gdjs.GameCode.GDPlayerNameInputObjects3);
{gdjs.evtTools.leaderboards.savePlayerScore(runtimeScene, "cb53c2e6-d603-4913-8728-ae0108ba3eee", gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(0)), (( gdjs.GameCode.GDPlayerNameInputObjects3.length === 0 ) ? "" :gdjs.GameCode.GDPlayerNameInputObjects3[0].getString()));
}{runtimeScene.getGame().getVariables().get("PlayerName").setString((( gdjs.GameCode.GDPlayerNameInputObjects3.length === 0 ) ? "" :gdjs.GameCode.GDPlayerNameInputObjects3[0].getString()));
}}
...
let isConditionTrue_0 = false;
{
{gdjs.evtTools.leaderboards.displayLeaderboard(runtimeScene, "cb53c2e6-d603-4913-8728-ae0108ba3eee", true);
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10201692);
}
if (isConditionTrue_0) {
gdjs.GameCode.GDFlashObjects2.length = 0;

{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.GameCode.mapOfGDgdjs_46GameCode_46GDFlashObjects2Objects, 0, 0, "GUI");
...
{for(var i = 0, len = gdjs.GameCode.GDPlayerNameInputObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDPlayerNameInputObjects2[i].setString(gdjs.playerAuthentication.getUsername());
}
}{for(var i = 0, len = gdjs.GameCode.GDPlayerNameInputObjects2.length ;i < len;++i) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.leaderboards.hasBeenSaved("cb53c2e6-d603-4913-8728-ae0108ba3eee");
}
if (isConditionTrue_0) {
